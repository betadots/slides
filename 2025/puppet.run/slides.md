...
[![conference-logo-slides](images/puppet-run.jpg)](https://puppet.run)
.div.lizenzblock[[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)]
...
* It can be used to deploy Puppet code from git repositories to Puppet Environments

* Isolate r10k in a container to avoid dependency hell on the host system

* Run r10k in kubernetes to deploy Puppet code in a k8s deployment
...
* On notification the webhook triggers r10k to deploy the changed Puppet code
...
* See it as a frozen testing environment for Puppet modules
